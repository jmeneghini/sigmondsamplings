...
class PhiRhoProjectDataParser(ss.PyCALQProjectDataParser):
    ...
    def _get_default_project_dir(self, L: Union[int, str]) -> Path:
        ...
        return Path(base) / f"latticeQCD/spectrum_analysis/channels/phirho/levels/john_results/s{L}/3fit_spectrum"
    ...
    def load_energy_levels_with_NI(self, 
                                  dataset_id: str,
                                  resampling_method: str,
                                  energy_types: Optional[List[str]] = None,
                                  ref: bool = False) -> Tuple[ss.EnsembleInfo, ss.SamplingInfo, 
    ...
    def filter_levels_by_criteria(self,
                                 ...
                                 is_relevant_psq_from_levels: Optional[callable] = None) -> Dict[int, Dict[int, Tuple[List, Dict[str, ss.SigmondSampling]]]]:
        """
