...
class TestSamplingStats(unittest.TestCase):
    ...
    def test_inconsistent_ensemble_error(self):
        ...
        obs_info_different = ObservableInfo(
            "different_obs", 0, "n", "re", different_ensemble
        )
        different_sampling = SigmondSampling(
            np.random.normal(0, 1, 101), obs_info_different, self.sampling_info
        )
    ...
    def test_inconsistent_sampling_error(self):
        ...
        obs_info_diff_sampling = ObservableInfo(
            "diff_sampling_obs", 0, "n", "re", self.ensemble_info
        )
        different_sampling = SigmondSampling(
    ...
    def test_different_lengths_error(self):
        ...
        short_sampling = SigmondSampling(short_data, obs_info_short, self.sampling_info)
